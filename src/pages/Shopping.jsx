...
const Shopping = () => {
  ...
  const TagOptions = [
    { TagId: 1, name: '소고기 1근(600g)', price: '10000' },
    { TagId: 2, name: '삼겹살 1근(600g)', price: '20000' },
    { TagId: 3, name: '목살 1근(600g)', price: '20000' },
    { TagId: 4, name: '버섯류', price: '20000' },
    { TagId: 5, name: '구이용 소시지', price: '20000' },
    { TagId: 6, name: '쌈무', price: '20000' },
    { TagId: 7, name: '상추', price: '20000' },
    { TagId: 8, name: '깻잎', price: '20000' },
    { TagId: 9, name: '마늘', price: '20000' },
    { TagId: 10, name: '양파', price: '20000' },
    { TagId: 11, name: '쌈장', price: '20000' },
    { TagId: 12, name: '고추장', price: '20000' },
    { TagId: 13, name: '소금', price: '20000' },
    { TagId: 14, name: '허브솔트', price: '20000' },
    { TagId: 15, name: '햇반', price: '20000' },
    { TagId: 16, name: '김치', price: '20000' },
    { TagId: 17, name: '김치찌개', price: '20000' },
    { TagId: 18, name: '된장찌개', price: '20000' },
    { TagId: 19, name: '일회용 젓가락', price: '20000' },
    { TagId: 20, name: '일회용 숟가락', price: '20000' },
    { TagId: 21, name: '일회용 접시', price: '20000' },
    { TagId: 22, name: '일회용 종이컵', price: '20000' },
    { TagId: 23, name: '일회용 소주컵', price: '20000' },
    { TagId: 24, name: '호일', price: '20000' },
    { TagId: 25, name: '소주', price: '20000' },
    { TagId: 26, name: '맥주', price: '20000' },
    { TagId: 27, name: '물', price: '20000' },
    { TagId: 28, name: '콜라', price: '20000' },
    { TagId: 29, name: '사이다', price: '20000' },
    { TagId: 30, name: '이온음료', price: '20000' },
    { TagId: 31, name: '과자', price: '20000' },
    { TagId: 32, name: '라면', price: '20000' },
  ];
